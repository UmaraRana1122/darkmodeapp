...
class ReadyForSelfie2Screen extends StatefulWidget {
  const ReadyForSelfie2Screen({Key? key}) : super(key: key);

  @override
  State<ReadyForSelfie2Screen> createState() => _ReadyForSelfie2ScreenState();
}
