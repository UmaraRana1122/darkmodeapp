...
import 'package:darkmodeapp/screens/interest_vivid.dart';
...
class SelectHeightScreen2 extends StatefulWidget {
  Function? onupdate;
  String? name;
  bool status;

  SelectHeightScreen2(
      {Key? key, this.onupdate, this.name, required this.status})
      : super(key: key);

  @override
  State<SelectHeightScreen2> createState() => _SelectHeightScreen2State();
}

class _SelectHeightScreen2State extends State<SelectHeightScreen2> {
